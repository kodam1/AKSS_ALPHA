<%@ Page  Title="Create Doctor" Async="true"  Language="C#" MasterPageFile="~/ABM/ABM.Master" AutoEventWireup="true" 
    CodeBehind="ABM_Master_Doctor_Create.aspx.cs" 
    Inherits="AKSS_Management.ABM.ABM_Master_Doctor_Create" %>
    ...
    <section class="section">
     ...
     <asp:Panel ID="Panel1" runat="server" class="card"  >      
          <div class="pagetitle my-3 mx-3">
             <h1><a id="A1_BtnBackDoctor_List" runat="server" class="m-1" href="/ABM/ABM_Master_Doctor_List.aspx"
                data-bs-toggle="tooltip" data-bs-placement="bottom" title="Back To Doctor's List">
                <i class="ri-arrow-left-line me-1"></i>
            </a>Create Doctor Master</h1>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          ...
          <div class="card ">
            <div class="card-body">
              <h5 class="card-title">Doctor Personal Info</h5> 
                
              <div class="row g-3 ">
                  <div class="col-md-6 mb-3">
                  <div class="form-floating">
                    <asp:TextBox id="TxtDoctorId" runat="server" class="form-control"  TextMode="Number" AutoPostBack="true" OnTextChanged="TxtDoctorId_TextChanged" ></asp:TextBox> 
             ...
             <div class="row g-3">
              <div class="col-md-6 mb-3">
               <div class="form-floating">
                  <asp:TextBox id="TxtDML_No" runat="server" class="form-control"  TextMode="Number" ></asp:TextBox>                                        
                 <label for="TxtDML_No">DML No.</label>
               </div>
             </div>
               <div class="col-md-6 mb-3">
                    <div class="form-floating mb-3">
                    <asp:DropDownList id="DdlDML_Saturation" runat="server" class="form-select"  aria-label="DdlDML_Saturation" >
                       <asp:ListItem Text="Dr" Value="Dr" Selected="True"></asp:ListItem>
                       <asp:ListItem Text="Mr" Value="Mr" ></asp:ListItem>
                       <asp:ListItem Text="Ms" Value="Ms" ></asp:ListItem>
                    </asp:DropDownList>
                    <label for="DdlDML_Saturation">DML Saturation</label>
                  </div>
               </div>
             </div>
              <div class="row g-3">
                <div class="col-md-6 mb-3">
                  <div class="form-floating">
                    <asp:TextBox id="TxtDOCTOR_Name" runat="server" class="form-control"   AutoPostBack="true" OnTextChanged="TxtDOCTOR_Name_TextChanged"  ></asp:TextBox>                                        
                    <label for="TxtDOCTOR_Name">Doctor Name</label>
                  </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div class="form-floating mb-3">
              ...
              <div class="row g-3">
                <div class="col-md-6 mb-3">                
                    <div class="form-floating mb-3">
                    <asp:DropDownList id="DdlSpeciality" runat="server" class="form-select"  aria-label="DdlSpeciality" >
                        <asp:ListItem Text="Select" Value="" Selected="True"></asp:ListItem>
                        <asp:ListItem Text="Cardiologist"  Value="Cardiologist" ></asp:ListItem>
                        <asp:ListItem Text="Consultant Physician"  Value="Consultant Physician" ></asp:ListItem>
                        <asp:ListItem Text="Dentist"  Value="Dentist" ></asp:ListItem>
                        <asp:ListItem Text="Diabetologist"  Value="Diabetologist" ></asp:ListItem>
                        <asp:ListItem Text="ENT Surgeon"  Value="ENT Surgeon" ></asp:ListItem>
                        <asp:ListItem Text="Gastroenterologist"  Value="Gastroenterologist" ></asp:ListItem>
                        <asp:ListItem Text="General Practitioner"  Value="General Practitioner" ></asp:ListItem>
                        <asp:ListItem Text="General Surgeon"  Value="General Surgeon" ></asp:ListItem>
                        <asp:ListItem Text="Gynecologist"  Value="Gynecologist" ></asp:ListItem>
                        <asp:ListItem Text="LSGP"  Value="LSGP" ></asp:ListItem>
                        <asp:ListItem Text="Orthopedic"  Value="Orthopedic" ></asp:ListItem>
                        <asp:ListItem Text="Pain Specialist"  Value="Pain Specialist" ></asp:ListItem>
                        <asp:ListItem Text="Physiotherapist"  Value="Physiotherapist" ></asp:ListItem>
                    </asp:DropDownList>
          ...
          <div class="col-lg-6">
              <div class="card ">
                  <div class="card-body">
                       <h5 class="card-title">Doctor Address Info</h5>  
                       <div class="row g-3 ">
             ...
             <div class="card ">
           <div class="card-body">
                <h5 class="card-title">Doctor Contact Info</h5>  
                <div class="row g-3 ">
                  <div class="col-md-6 mb-3">
                    <div class="form-floating mb-3">
             ...
             <div class="col-lg-12">
                 <div class="card-body">
                     ...
                     <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" 
                                    CssClass="table datatable" DataKeyNames="Dr_Id"
                                    ShowHeader="true"
                                    >
                         <Columns>
                                <asp:BoundField DataField="Dr_Id" HeaderText="Dr Id" />
                                <asp:BoundField DataField="Division_Name" HeaderText="Division Name" />
                                <asp:BoundField DataField="DML_No" HeaderText="DML No" />
                                <asp:BoundField DataField="DML_Saturation" HeaderText="DML Saturation" />
