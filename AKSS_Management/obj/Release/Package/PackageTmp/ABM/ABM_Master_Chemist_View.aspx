<%@ Page Title="Chemist Master View" Async="true"  Language="C#" MasterPageFile="~/ABM/ABM.Master" AutoEventWireup="true" 
    CodeBehind="ABM_Master_Chemist_View.aspx.cs" 
    Inherits="AKSS_Management.ABM.ABM_Master_Chemist_View" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Chemist Master View</li>
        </ol>
      </nav>
    </div>
    <!-- End Page Title -->
    ...
    <section class="section">
     ...
     <asp:Panel ID="Panel1" runat="server" class="card"  >
             ...
             <h1><a id="A1_BtnBack_Chemist_Master_List" runat="server" class="m-1" href="/ABM/ABM_Master_Chemist_List.aspx"
                     data-bs-toggle="tooltip" data-bs-placement="bottom" title="Back To Chemist Master List">
                     <i class="ri-arrow-left-line me-1"></i>
                 </a>Chemist Master View</h1>
         </div>
          ...
          <div class="card ">
            <div class="card-body">
                ...
                <div class="row g-3 my-3 m-3">
                    <div class="col-lg-6">
                        <div class="row ">
                            <label for="LblChemist_Id" class="col-sm-12 col-form-label">Chemist ID</label>
                            <div class="col-sm-12">
                                <asp:Label ID="LblChemist_Id_Data" runat="server" class="col-form-label" Text="" Font-Bold="True"></asp:Label>
                            </div>
                        </div>
                        <div class="row ">
                        ...
                        <div class="row ">
                            <label for="LblCML_No" class="col-sm-12 col-form-label">CML No</label>
                            <div class="col-sm-12">
                                <asp:Label ID="LblCML_No_Data" runat="server" class="col-form-label" Text="" Font-Bold="True"></asp:Label>
                            </div>
                        </div>
                        <div class="row ">
                            <label for="LblCML_Saturation" class="col-sm-12 col-form-label">CML Saturation</label>
                            <div class="col-sm-12">
                                <asp:Label ID="LblCML_Saturation_Data" runat="server" class="col-form-label" Text="" Font-Bold="True"></asp:Label>
                            </div>
                        </div>
                        <div class="row ">
                            <label for="LblCHEMIST_Name" class="col-sm-12 col-form-label">Chemist Name</label>
                            <div class="col-sm-12">
                                <asp:Label ID="LblCHEMIST_Name_Data" runat="server" class="col-form-label" Text="" Font-Bold="True"></asp:Label>
                            </div>
                        </div>
                        <div class="row ">
