<%@ Page  Title="Doctor Master View" Async="true"  Language="C#" MasterPageFile="~/ABM/ABM.Master" 
    AutoEventWireup="true" CodeBehind="ABM_Master_Doctor_View.aspx.cs" 
    Inherits="AKSS_Management.ABM.ABM_Master_Doctor_View" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Doctor Master View</li>
        </ol>
      </nav>
    </div>
    <!-- End Page Title -->
    ...
    <section class="section">
     ...
     <asp:Panel ID="Panel1" runat="server" class="card"  >
             ...
             <h1><a id="A1_BtnBack_Doctor_Master_List" runat="server" class="m-1" href="/ABM/ABM_Master_Doctor_List.aspx"
                     data-bs-toggle="tooltip" data-bs-placement="bottom" title="Back To Doctor Master List">
                     <i class="ri-arrow-left-line me-1"></i>
                 </a>Doctor Master View</h1>
         </div>
          ...
          <div class="card ">
            <div class="card-body">
                ...
                <div class="row g-3 my-3 m-3">
                    <div class="col-lg-6">
                          <div class="row ">
      <label for="LblDr_Id" class="col-sm-12 col-form-label">Dr ID</label>
      <div class="col-sm-12">
          <asp:Label ID="LblDr_Id_Data" runat="server" class="col-form-label" Text="" Font-Bold="True"></asp:Label>
      </div>
  </div>
  <div class="row ">
  ...
  <div class="row ">
      <label for="LblDML_No" class="col-sm-12 col-form-label">DML No</label>
      <div class="col-sm-12">
          <asp:Label ID="LblDML_No_Data" runat="server" class="col-form-label" Text="" Font-Bold="True"></asp:Label>
      </div>
  </div>
  <div class="row ">
      <label for="LblDML_Saturation" class="col-sm-12 col-form-label">DML Saturation</label>
      <div class="col-sm-12">
          <asp:Label ID="LblDML_Saturation_Data" runat="server" class="col-form-label" Text="" Font-Bold="True"></asp:Label>
      </div>
  </div>
  <div class="row ">
      <label for="LblDOCTOR_Name" class="col-sm-12 col-form-label">Doctor Name</label>
      <div class="col-sm-12">
          <asp:Label ID="LblDOCTOR_Name_Data" runat="server" class="col-form-label" Text="" Font-Bold="True"></asp:Label>        
      </div>
  </div>
  <div class="row ">
  ...
  <div class="row ">
      <label for="LblSpeciality" class="col-sm-12 col-form-label">Speciality</label>
      <div class="col-sm-12">
          <asp:Label ID="LblSpeciality_Data" runat="server" class="col-form-label" Text="Male" Font-Bold="True"></asp:Label>
      </div>
  </div>
                        <div class="row ">
