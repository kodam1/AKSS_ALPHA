<%@ Page Title="Certificates" Language="C#" MasterPageFile="~/CMIS/CMIS.Master" AutoEventWireup="true" 
    CodeBehind="CMIS_Create_Certificates.aspx.cs" Inherits="AKSS_Management.CMIS.CMIS_Create_Certificates" %>
                         ...
                         <ContentTemplate>
                             ...
                             <div class="row g-3 mb-3">
                                 ...
                                 <div class="text-center">
                                     ...
                                     <asp:Button ID="BtnDeveloperSubmit" runat="server" Text="Submit"  class="btn btn-primary" /> <%--OnClick="BtnDeveloperSubmit_Click"--%>
                                     <asp:Button ID="BtnDeveloperReset" runat="server" Text="Reset"  type="reset" class="btn btn-secondary" /> <%--OnClick="BtnDeveloperReset_Click"--%>
                                     <asp:Button ID="BtnDeveloper_Print" runat="server" Text="Print"  class="btn btn-primary" /> <%--OnClientClick="printDiv();"--%>
                        ...
                        <ContentTemplate>
                         ...
                         <div class="row g-3 mb-3">
                            ...
                            <div class="text-center">
                                ...
                                <asp:Button ID="BtnDBA_Save" runat="server" Text="Submit"  class="btn btn-primary"/> <%--OnClick="BtnDBA_Save_Click"--%>                               
                                <asp:Button ID="BtnDBA_Reset" runat="server" Text="Reset"  type="reset" class="btn btn-secondary"/> <%--OnClick="BtnDBA_Reset_Click"--%>
                                <asp:Button ID="BtnDBA_Print" runat="server" Text="Print"  class="btn btn-primary"/> <%--OnClientClick="printDiv();"--%>
