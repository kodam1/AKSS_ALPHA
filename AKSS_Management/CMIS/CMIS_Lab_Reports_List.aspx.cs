...
{
    public partial class CMIS_Lab_Reports_List : System.Web.UI.Page
    {
        ...
        protected async void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Select" || e.CommandName == "GvBtn_View")
            {
                ...
                if (id != null)
                {
                    Response.Redirect("/CMIS/CMIS_Create_Lab_Reports_Details.aspx?Lab_Report_ID=" + id, false);
                }
            }
            else if (e.CommandName == "A_GvBtn_Edit" || e.CommandName == "GvBtn_Edit")
            {
                ...
                if (id != null)
                {
                    Response.Redirect("/CMIS/CMIS_Create_Lab_Reports.aspx?Lab_Report_ID=" + id, false);
                }
            }
            else if (e.CommandName == "A_GvBtn_Delete" || e.CommandName == "GvBtn_Delete")
            {
                ...
                if (id != null)
                {
                    try
                    {
                        ...
                        new SqlParameter("@Lab_Report_ID" , Convert.ToInt32(id))
                        };
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (HfId.Value != null)
            {
                Response.Redirect("/CMIS/CMIS_Create_Lab_Reports_Details.aspx?Lab_Report_ID=" + HfId.Value);
            }
        }
        ...
        protected async void Txt_GV_Custom_Search_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "Txt_GV_Custom_Search_TextChanged", "alert('Data Not Present !');", true);
                }
            }
            catch
            {
