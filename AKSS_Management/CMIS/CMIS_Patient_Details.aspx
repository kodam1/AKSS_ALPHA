          ...
          <div class="card ">
            <div class="card-body">
                  ...
                  <div class="row g-3 my-3 m-3" >
                    ...
                    <a id="A48" runat="server" class="btn btn-success m-2" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Copy"  visible="true"     ><i class="bx bx-copy me-1" style="font-size: x-large;"></i><br /><span style="font-size:medium;" >Copy</span></a>
                  
                    <a id="A_Call" runat="server" href="#" target="_blank"  class="btn btn-primary m-2" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Call"     visible="true" ><i class="bx bxs-phone-call me-1" style="font-size: x-large;"></i><br /><span style="font-size:medium;" >Call</span></a>
                    <a id="A_Message" runat="server" href="#" target="_blank"  class="btn btn-info m-2" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Message"   visible="true"><i class="bx bxs-message-alt-detail me-1" style="font-size: x-large;"></i><br /><span style="font-size:medium;" >Message</span></a>
                    <a id="A_WhatsApp" runat="server" href="#" target="_blank"  class="btn btn-success m-2" data-bs-toggle="tooltip" data-bs-placement="bottom" title="WhatsApp"  visible="true"><i class="bx bxl-whatsapp me-1" style="font-size: x-large;"></i><br /><span style="font-size:medium;" >WhatsApp</span></a>
                    <a id="A_Mail" runat="server" href="#" target="_blank"  class="btn btn-warning m-2" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Mail"     visible="true" ><i class="bx bx-mail-send me-1" style="font-size: x-large;"></i><br /><span style="font-size:medium;" >Mail</span></a>                               
