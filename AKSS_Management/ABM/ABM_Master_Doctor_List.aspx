<%@ Page Title="Doctor Master List"  Async="true" Language="C#" 
    MasterPageFile="~/ABM/ABM.Master" AutoEventWireup="true" 
    CodeBehind="ABM_Master_Doctor_List.aspx.cs" 
    Inherits="AKSS_Management.ABM.ABM_Master_Doctor_List" %>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Doctor Master List</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="card-body" style="padding: 0 0px 20px 0px;">
              <%--<h5 class="card-title">Doctor Master List</h5>--%>
                ...
                <div class="row g-3 m-1">
                    <div class="col-lg-12">
                        <span style="font-size: large">Doctor Master List
                        </span>
                        <span style="float: right;">
                            <a id="A1_BtnAddMasterDoctorCreate" runat="server" class="m-1" href="/ABM/ABM_Master_Doctor_Create.aspx"
                                data-bs-toggle="tooltip" data-bs-placement="bottom" title="Add Doctor Master">
                        ...
                        <div class="card-body">--%>
                            ...
                            OnRowCreated="GridView1_RowCreated" --%>
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Dr_Id" HeaderText="Sr No." />
