<%@ Page Title="ABM Sub Dashboard" Async="true" Language="C#" MasterPageFile="~/ABM/ABM.Master" 
    AutoEventWireup="true" 
    CodeBehind="ABM_Category_Dashboard.aspx.cs" 
    Inherits="AKSS_Management.ABM.ABM_Category_Dashboard" %>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">ABM Sub Dashboard</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
          ...
          <div class="col-lg-4">
            <div class="info-box card" style="text-align: center;background-color: #3a90d687;">
              ...
              <%--<p>info@example.com<br>contact@example.com</p>--%>
                <asp:Label ID="LblAppointments_Id" runat="server" Text="1200" ></asp:Label>
            </div>
          </div>
           ...
           <div class="modal fade" id="AppointmentsModal" tabindex="-1">
            ...
            <div class="col-lg-4">
              <div class="info-box card " style="text-align: center;background-color: #00eaff8c;">
                ...
                <h3>Doctor Master &nbsp;<i class="bi bi-question-circle-fill" data-bs-toggle="modal" data-bs-target="#DoctorMaster"
                    style="font-size: 28px;"></i></h3>
                  
                <%--<p>A108 Adam Street,<br>New York, NY 535022</p>--%>
                  <asp:Label ID="lblDoctorMaster" runat="server" Text="500" ></asp:Label>
              </div>
            </div>

               <!-- Doctor Master  Modal -->             
             <div class="modal fade" id="DoctorMaster" tabindex="-1">
               <div class="modal-dialog modal-sm">
                 <div class="modal-content">
                   <div class="modal-header">
                   ...
                   <div class="modal-body">
                      Total number of newly Doctor master created in the filtered date range.
                   </div>
                   <div class="modal-footer">
                     <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                     <%--<button type="button" class="btn btn-primary">Save changes</button>--%>
               ...
               <!-- End Doctor Master   Modal-->


            <div class="col-lg-4">
              <div class="info-box card" style="text-align: center;    background-color: #00ff4e8c;">
                <%--<i class="bx-dollar-circle"></i>--%>
                <h3>Chemist Master &nbsp;<i class="bi bi-question-circle-fill"  data-bs-toggle="modal" data-bs-target="#ChemistMaster"
                    style="font-size: 28px;"></i></h3>
                <%--<p>+1 5589 55488 55<br>+1 6678 254445 41</p>--%>
                  <asp:Label ID="lblChemistMaster" runat="server" Text="900" ></asp:Label>
              </div>
            </div>
              
               <!-- Chemist Master Modal -->             
             <div class="modal fade" id="ChemistMaster" tabindex="-1">
               <div class="modal-dialog modal-sm">
                 <div class="modal-content">
                   <div class="modal-header">
                     <h5 class="modal-title">Chemist</h5>
                     <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                   </div>
                   <div class="modal-body">
                      Total number of newly Chemist master created in the filtered date range.
                   </div>
                   <div class="modal-footer">
                     <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                     <%--<button type="button" class="btn btn-primary">Save changes</button>--%>
               ...
               <!-- End Chemist Master Modal-->
          
            <div class="col-lg-4">
              <div class="info-box card" style="text-align: center;background-color: #a23ad687;">
                <%--<i class="bi bi-person-plus"></i>--%>
                <h3>Stockist Master &nbsp;<i class="bi bi-question-circle-fill"  data-bs-toggle="modal" data-bs-target="#StockistMaster"
                    style="font-size: 28px;"></i></h3>
                <%--<p>Monday - Friday<br>9:00AM - 05:00PM</p>--%>
                  <asp:Label ID="lblStockistMaster" runat="server" Text="93" ></asp:Label>
              </div>
            </div>

             <!-- Stockist Master Modal -->             
             <div class="modal fade" id="StockistMaster" tabindex="-1">
               <div class="modal-dialog modal-sm">
                 <div class="modal-content">
                   <div class="modal-header">
                     <h5 class="modal-title">Stockist</h5>
                     <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                   </div>
                   <div class="modal-body">
                        Total number of newly Stockist master created in the filtered date range.
                   </div>
                   <div class="modal-footer">
                     <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <%-- <button type="button" class="btn btn-primary">Save changes</button>--%>
