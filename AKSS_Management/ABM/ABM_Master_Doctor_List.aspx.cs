...
{
    public partial class ABM_Master_Doctor_List : System.Web.UI.Page
    {
        ...
        protected async void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Select" || e.CommandName == "GvBtn_View")
            {
                ...
                if (id != null)
                {
                    Response.Redirect("/ABM/ABM_Master_Doctor_View.aspx?Dr_Id=" + id, false);
                }
            }
            else if (e.CommandName == "A_GvBtn_Edit" || e.CommandName == "GvBtn_Edit")
            {
                ...
                if (id != null)
                {
                    Response.Redirect("/ABM/ABM_Master_Doctor_Create.aspx?Dr_Id=" + id, false);
                }
            }
            else if (e.CommandName == "A_GvBtn_Delete" || e.CommandName == "GvBtn_Delete")
            {
                ...
                if (id != null)
                {
                    try
                    {
                        ...
                        new SqlParameter("@Dr_Id" , Convert.ToInt32(id))
                        };
