<%@ Page  Title="Send Bulk Email"  Async="true"  Language="C#" MasterPageFile="~/AKodam_Management/AKSS_Management.Master" 
    AutoEventWireup="true" CodeBehind="AKSS_Email_test.aspx.cs" 
    Inherits="AKSS_Management.AKodam_Management.AKSS_Email_test"  validateRequest="false"
    %>
    ...
    <section class="section">
     ...
     <asp:Panel ID="PnlGV" runat="server" class="card" ScrollBars="Auto" Width="100%" style="height:auto;" Visible="true" >
         ...
         <div class="row">
             <div class="col-lg-12">
                 <div class="card-body">
                     <h5 class="card-title">Test Client Email List</h5>
